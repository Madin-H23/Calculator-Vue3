...
> 完整 29 步 commit hash 见 [`docs/ai-chat/index.md`](docs/ai-chat/index.md)。另有 2 个前置规划提交(`03d4181`、`6daca01`)与 2 个交付后内存扩展提交(`68c53c8` MC/MR/M+/M-/MS、`3b4c450` M 徽标)。

## 还原说明

- **视觉基准**:`PROMPT.md` §4(色板 / 4×6 网格 / 字号 / 浅深主题)。
- **功能**:`8 + 9 = 17`、`9 ÷ 0 =` → `不能除以零`、`1/x`、`x²`、`√x`、负数开方 → `无效输入`、`%`、`±`、`⌫`、`C / CE`、小数点防重复;**内存** MC/MR/M+/M-/MS(单寄存器 + `M` 徽标,`M▾` 占位);运算符选中高亮;🌙 / ☀ 浅 / 深主题切换。
